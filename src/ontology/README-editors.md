These notes are for the EDITORS of echo
...
Make sure you have an ID range in the [idranges file](echo-idranges.owl)

If you do not have one, get one from the maintainer of this repo.

The editors version is [echo-edit.owl](echo-edit.owl)

** DO NOT EDIT echo.obo OR echo.owl in the top level directory **

[../../echo.owl](../../echo.owl) is the release version

To edit, open the file in Protege. First make sure you have the repository cloned, see [the GitHub project](https://github.com/pellst/echo) for details.
 ...
 * [echo-idranges.owl](echo-idranges.owl)
...
There are two ways to include new classes in an import module
 ...
 2. Add to the imports/echo_terms.txt file
...
Note: the echo_terms.txt file may include 'starter' classes seeded from
...
This generates derived files such as echo.owl and echo.obo and places
 ...
 * https://github.com/pellst/echo/releases
 * https://github.com/pellst/echo/releases/new
...
what is in the `owl:versionIRI` of the derived echo.owl (`data-version` in
echo.obo). This will be today's date.
 ...
 * http://purl.obolibrary.org/obo/echo.owl <-- current ontology PURL
 * http://purl.obolibrary.org/obo/echo/releases/YYYY-MM-DD.owl <-- change to the release you just made

For questions on this contact Chris Mungall or email obo-admin AT obofoundry.org

# Travis Continuous Integration System

Check the build status here: [![Build Status](https://travis-ci.org/pellst/echo.svg?branch=master)](https://travis-ci.org/pellst/echo)

Note: if you have only just created this project you will need to authorize travis for this repo.

 1. Go to [https://travis-ci.org/profile/pellst](https://travis-ci.org/profile/pellst)
 2. click the "Sync account" button
 3. Click the tick symbol next to echo
