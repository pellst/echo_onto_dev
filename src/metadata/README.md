 ...
 * [echo.yml](echo.yml)
     * Determines how your purl.obolibrary.org/obo/echo/ redirects will be handled
     ...
     * Paste in the contents of [echo.yml](echo.yml)
 ...
 * [echo.md](echo.md)
     ...
     * Paste in the contents of [echo.md](echo.md)
     * Click "Commit new file"
     * IMPORTANT: remember to make a pull request
     * An OBO admin will merge your Pull Request *providing it meets the requirements of the OBO library*
